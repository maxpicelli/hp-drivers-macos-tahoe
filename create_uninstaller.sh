...
# Script para criar um executável portável do desinstalador de drivers HP
# Este script cria um arquivo executável que pode ser movido para qualquer lugar

echo "=== Criador de Executável HP Drivers Uninstaller ==="
echo ""
...
# Nome do executável
EXECUTABLE_NAME="HP_Drivers_Uninstaller"
...
# HP Drivers Uninstaller - Executável Portável
# Versão: 3.4.0
...
echo "- Execute: sudo ./HP_Drivers_Installer"
EOF
...
echo "e funcionará independentemente do diretório atual."
