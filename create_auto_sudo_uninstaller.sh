...
# Script para criar um executável de desinstalação que automaticamente solicita sudo
# Este executável verifica se tem privilégios e solicita se necessário

echo "=== Criador de Executável Auto-Sudo HP Drivers Uninstaller ==="
echo ""
...
# Nome do executável
EXECUTABLE_NAME="HP_Drivers_Uninstaller_Auto"
